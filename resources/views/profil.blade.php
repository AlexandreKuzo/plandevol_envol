        ...
        <div class="column is-10">
            <div class="card">
                <header class="card-header">
                    <p class="card-header-title">Voici ci-dessous le récapitulatif de ton dernier positionnement sur le radar de vol</p>
                    <p class="card-header-title">Rempli le : @foreach(auth()->user()->positionnement as $positionnement) {{ $positionnement->created_at->format('d/m/Y') }}</p>
                    @endforeach

                    <div class="card-content"> <p><a class="button is-link is-rounded has-text-centered" href="/previous">TELECHARGER LE PDF</a></p></div>
     ...
     <div class="columns is-marginless is-centered">
        <div class="column is-10">
            <div class="card">
                ...
                <div class="card-content">
                <div class="card-control">
                    <h1 class="">Les dispositifs sur lesquels tu comptes t'appuyer pour avancer.</h1>
